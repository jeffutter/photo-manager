...
let keyframes = (frames) =>
  makeKeyFrames(
    frames |> List.map(((k, v)) => (k, declarationsToObj(v))) |> Js.Dict.fromList
  ); /*
   ==============
   CSS properties
   ==============
...
let zIndex = (v) => Property("zIndex", v) /* Color Level 3 - REC */; /* Below properties based on https://www.w3.org/Style/CSS/all-properties */

let opacity = (v) =>
  Property("opacity", v) /* backgroundAttachment - already defined by CSS2Properties */ /* backgroundRepeat - already defined by CSS2Properties */; /* Backgrounds and Borders Level 3 - CR */
...
let boxShadow = (v) => Property("boxShadow", v); /* Multi-column Layout - CR */
...
let breakInside = (v) => Property("breakInside", v); /* Speech - CR */
...
let voiceVolume = (v) =>
  Property("voiceVolume", v); /* Image Values and Replaced Content Level 3 - CR */
...
let imageOrientation = (v) => Property("imageOrientation", v); /* Flexible Box Layout - CR */
...
let order = (v) => Property("order", v) /* textDecoration - already defined by CSS2Properties */; /* Text Decoration Level 3 - CR */
...
let textEmphasisStyle = (v) =>
  Property("textEmphasisStyle", v); /* textShadow - already defined by CSS2Properties */

let textUnderlinePosition = (v) => Property("textUnderlinePosition", v); /* Fonts Level 3 - CR */

let fontFeatureSettings = (v) => Property("fontFeatureSettings", v);

let fontKerning = (v) => Property("fontKerning", v);

let fontLanguageOverride = (v) =>
  Property("fontLanguageOverride", v) /* fontStretch - already defined by CSS2Properties */; /* fontSizeAdjust - already defined by CSS2Properties */
...
let fontVariantPosition = (v) =>
  Property("fontVariantPosition", v); /* Cascading and Inheritance Level 3 - CR */

let all = (v) => Property("all", v); /* Writing Modes Level 3 - CR */
...
let writingMode = (v) => Property("writingMode", v); /* Shapes Level 1 - CR */

let shapeImageThreshold = (v) => Property("shapeImageThreshold", v);

let shapeMargin = (v) => Property("shapeMargin", v);

let shapeOutside = (v) => Property("shapeOutside", v); /* Masking Level 1 - CR */
...
let maskType = (v) => Property("maskType", v); /* Compositing and Blending Level 1 - CR */

let backgroundBlendMode = (v) => Property("backgroundBlendMode", v);

let isolation = (v) => Property("isolation", v);

let mixBlendMode = (v) => Property("mixBlendMode", v); /* Fragmentation Level 3 - CR */

let boxDecorationBreak = (v) =>
  Property("boxDecorationBreak", v) /* Basic User Interface Level 3 - CR */ /* breakInside - already defined by Multi-column Layout */ /* breakBefore - already defined by Multi-column Layout */; /* breakAfter - already defined by Multi-column Layout */
...
let textOverflow = (v) => Property("textOverflow", v); /* Grid Layout Level 1 - CR */
...
let gridTemplateRows = (v) => Property("gridTemplateRows", v); /* Will Change Level 1 - CR */

let willChange = (v) => Property("willChange", v); /* Text Level 3 - LC */

let hangingPunctuation = (v) => Property("hangingPunctuation", v);

let hyphens = (v) =>
  Property("hyphens", v); /* letterSpacing - already defined by CSS2Properties */

let lineBreak = (v) => Property("lineBreak", v);

let overflowWrap = (v) => Property("overflowWrap", v);

let tabSize = (v) => Property("tabSize", v); /* textAlign - already defined by CSS2Properties */
...
let wordWrap = (v) => Property("wordWrap", v); /* Animations - WD */
...
let animationTimingFunction = (v) => Property("animationTimingFunction", v); /* Transitions - WD */
...
let transitionTimingFunction = (v) =>
  Property("transitionTimingFunction", v); /* Transforms Level 1 - WD */
...
let transformStyle = (v) =>
  Property("transformStyle", v) /* alignItems - already defined by Flexible Box Layout */ /* alignContent - already defined by Flexible Box Layout */; /* Box Alignment Level 3 - WD */
...
let placeSelf = (v) => Property("placeSelf", v); /* Basic User Interface Level 4 - FPWD */
...
let userSelect = (v) => Property("userSelect", v); /* Overflow Level 3 - WD */

let maxLines = (v) => Property("maxLines", v); /* Basix Box Model - WD */
...
let rotationPoint = (v) => Property("rotationPoint", v); /* svg */
