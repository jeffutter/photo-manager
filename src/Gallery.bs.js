          ...
          /* render */(function (self) {
              ...
              return ReasonReact.element(undefined, undefined, WindowScroller$PhotoManager.make((function (scrollerOptions) {
                                return React.createElement("div", {
                                          ...
                                          }, ReasonReact.element(undefined, undefined, BreadCrumbs$PhotoManager.make(path, slug, name, /* array */[])), ReasonReact.element(undefined, undefined, GalleryBody$PhotoManager.make(self[/* state */1][/* descendants */4], openLightbox, loadImage, scrollerOptions.height, scrollerOptions.isScrolling, scrollerOptions.onChildScroll, scrollerOptions.scrollTop, /* array */[])), ReasonReact.element(undefined, undefined, PhotoSwipe$PhotoManager.make(self[/* state */1][/* lightboxIsOpen */0], swipeImages, (function () {
