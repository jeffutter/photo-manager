          ...
          /* render */(function () {
              if (slug === "root") {
                return React.createElement("div", {
                            className: cls
                          }, ReasonReact.element(undefined, undefined, NavLink$PhotoManager.make("/gallery", activeCls, undefined, /* array */["Gallery"])));
              } else {
                ...
                var links = pathObjs.map((function (param, idx) {
                        return React.createElement("span", {
                                    key: idx.toString()
                                  }, ReasonReact.element(undefined, undefined, NavLink$PhotoManager.make(param[/* path */1], activeCls, undefined, /* array */[param[/* name */0]])), " / ");
                      }));
                var rootNavLink = ReasonReact.element(undefined, undefined, NavLink$PhotoManager.make("/gallery", activeCls, undefined, /* array */["Gallery"]));
