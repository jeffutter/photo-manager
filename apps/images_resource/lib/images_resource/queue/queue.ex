defmodule ImagesResource.Queue.Queue do
  ...
  @spec add_sync_batch(term, list({any, any}), Keyword.t) :: {:ok, list({any, {:ok, any}})} | {:error, String.t, any}
  ...
  def handle_cast({:push, event, from, reply}, queue = %__MODULE__{q: q, name: name}) do
